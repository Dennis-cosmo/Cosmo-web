    ...
    <main className="py-6 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-deep-space min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 sm:mt-0">
            ...
            >
              ...
              {hasSyncedData ? "Actualizar datos" : "Configurar sincronización"}
            </Link>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  <input
                    ...
                    name="search"
                    id="search"
                    className="focus:ring-eco-green focus:border-eco-green block w-full pl-3 pr-10 py-2 sm:text-sm border-gray-300 rounded-md dark:bg-cosmo-700 dark:border-cosmo-600 dark:text-white"
                    placeholder="Descripción, importe..."
                  />
        ...
        {expenses.length > 0 ? (
                    ...
                    <tbody className="bg-white dark:bg-cosmo-800 divide-y divide-gray-200 dark:divide-cosmo-700">
                      {expenses.map((expense) => (
                        <tr key={expense.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                            {expense.supplier || "Desconocido"}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                            {expense.paymentMethod || "Desconocido"}
                          </td>
          ...
          <div className="bg-white dark:bg-cosmo-800 shadow rounded-lg p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Sincroniza con tu cuenta de QuickBooks para importar tus gastos.
            </p>
            <div className="mt-6">
              <Link
                href="/integrations/quickbooks"
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-eco-green hover:bg-lime-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-eco-green"
              >
                <svg
                  className="-ml-1 mr-2 h-5 w-5"
                  xmlns="http://www.w3.org/2000/svg"
